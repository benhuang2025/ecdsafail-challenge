// secp256k1 field arithmetic lifted VERBATIM from VanitySearch GPUMath.h (GPL-3.0,
// (c) 2019 Jean-Luc Pons). Used LOCAL-ONLY for nonce search; never distributed/pushed.
